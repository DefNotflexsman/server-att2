...
class GitTag(Framework.TestCase):
    def setUp(self):
        super().setUp()
        self.tag = self.g.get_repo("PyGithub/PyGithub").get_git_tag(
            "f5f37322407b02a80de4526ad88d5f188977bc3c"
        )
    ...
    def testAttributes(self):
        ...
        self.assertEqual(
            self.tag.node_id,
            "MDM6VGFnMzU0NDQ5MDpmNWYzNzMyMjQwN2IwMmE4MGRlNDUyNmFkODhkNWYxODg5NzdiYzNj",
        )
        self.assertEqual(
            self.tag.object.sha, "4303c5b90e2216d927155e9609436ccb8984c495"
        )
        self.assertEqual(self.tag.object.type, "commit")
        self.assertEqual(
            self.tag.object.url,
            "https://api.github.com/repos/PyGithub/PyGithub/git/commits/4303c5b90e2216d927155e9609436ccb8984c495",
        )
        self.assertEqual(self.tag.sha, "f5f37322407b02a80de4526ad88d5f188977bc3c")
        self.assertEqual(self.tag.tag, "v0.6")
        self.assertEqual(
            self.tag.tagger.date, datetime(2012, 5, 10, 18, 14, 15, tzinfo=timezone.utc)
        )
