...
class Milestone(Framework.TestCase):
    ...
    def testAttributes(self):
        self.assertEqual(
            self.milestone.closed_at,
            datetime(2012, 3, 12, 22, 18, 49, tzinfo=timezone.utc),
        )
        ...
        self.assertEqual(
            self.milestone.due_on, datetime(2012, 3, 13, 7, 0, 0, tzinfo=timezone.utc)
        )
        self.assertEqual(
            self.milestone.html_url, "https://github.com/PyGithub/PyGithub/milestone/1"
        )
        self.assertEqual(self.milestone.id, 93546)
        self.assertEqual(
            self.milestone.labels_url,
            "https://api.github.com/repos/PyGithub/PyGithub/milestones/1/labels",
        )
        ...
        self.assertEqual(
            self.milestone.updated_at,
            datetime(2012, 9, 11, 18, 48, 34, tzinfo=timezone.utc),
        )
        self.assertEqual(
            self.milestone.url,
            "https://api.github.com/repos/PyGithub/PyGithub/milestones/1",
        )
        self.assertEqual(self.milestone.creator.login, "jacquev6")
        self.assertEqual(
