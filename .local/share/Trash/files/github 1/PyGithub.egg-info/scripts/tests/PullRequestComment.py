...
class PullRequestComment(Framework.TestCase):
    def setUp(self):
        super().setUp()
        self.comment = (
            self.g.get_repo("PyGithub/PyGithub").get_pull(31).get_comment(1580134)
        )
    ...
    def testAttributes(self):
        self.assertEqual(
            ...
            {
                "html": {
                    "href": "https://github.com/PyGithub/PyGithub/pull/31#discussion_r1580134"
                },
                "pull_request": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/31"
                },
                "self": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/comments/1580134"
                },
            },
        )
        ...
        self.assertEqual(
            ...
            datetime(2012, 9, 11, 20, 6, 32, tzinfo=timezone.utc),
        )
        self.assertEqual(len(self.comment.diff_hunk), 434)
        self.assertEqual(
            self.comment.html_url,
            "https://github.com/PyGithub/PyGithub/pull/31#discussion_r1580134",
        )
        ...
        self.assertEqual(
            self.comment.pull_request_url,
            "https://api.github.com/repos/PyGithub/PyGithub/pulls/31",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.comment.url,
            "https://api.github.com/repos/PyGithub/PyGithub/pulls/comments/1580134",
        )
        ...
        self.assertEqual(
            repr(self.comment),
            'PullRequestComment(user=NamedUser(login="jacquev6"), id=1580134)',
        )
