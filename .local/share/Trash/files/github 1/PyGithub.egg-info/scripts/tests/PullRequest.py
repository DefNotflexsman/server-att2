...
class PullRequest(Framework.TestCase):
    ...
    def testAttributes(self):
        self.assertEqual(
            ...
            {
                "self": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/31"
                },
                "html": {"href": "https://github.com/PyGithub/PyGithub/pull/31"},
                "issue": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/issues/31"
                },
                "comments": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/issues/31/comments"
                },
                "review_comments": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/31/comments"
                },
                "review_comment": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/comments{/number}"
                },
                "commits": {
                    "href": "https://api.github.com/repos/PyGithub/PyGithub/pulls/31/commits"
                },
                "statuses": {
        ...
        self.assertEqual(
            self.pull.comments_url,
            "https://api.github.com/repos/PyGithub/PyGithub/issues/31/comments",
        )
        self.assertEqual(self.pull.commits, 3)
        self.assertEqual(
            self.pull.commits_url,
            "https://api.github.com/repos/PyGithub/PyGithub/pulls/31/commits",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.pull.merge_commit_sha, "28ae6dd10ebccd5eaf8db8dacb5b699ee7f4a663"
        )
        ...
        self.assertEqual(
            self.pull.merged_at, datetime(2012, 5, 27, 10, 29, 7, tzinfo=timezone.utc)
        )
        ...
        self.assertEqual(
            self.pull.review_comment_url,
            "https://api.github.com/repos/PyGithub/PyGithub/pulls/comments{/number}",
        )
        self.assertEqual(self.pull.review_comments, 2)
        self.assertEqual(
            self.pull.review_comments_url,
            "https://api.github.com/repos/PyGithub/PyGithub/pulls/31/comments",
        )
    ...
    def testGetReviewComments(self):
        ...
        self.assertListKeyEqual(comments, lambda c: c.id, [197784357, 1580134])
        self.assertListKeyEqual(
            comments, lambda c: c.pull_request_review_id, [131593233, None]
        )
