...
class Gist(Framework.TestCase):
    def testAttributes(self):
        ...
        self.assertEqual(
            gist.comments_url, "https://api.github.com/gists/6296732/comments"
        )
        self.assertEqual(
            gist.commits_url, "https://api.github.com/gists/6296732/commits"
        )
        self.assertEqual(
            gist.created_at,
        ...
        self.assertEqual(gist.fork_of.id, "6296553")
        self.assertEqual(gist.forks, [])
        self.assertEqual(gist.forks_url, "https://api.github.com/gists/6296732/forks")
