...
class CodeScanAlert(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(
            alert.created_at, datetime(2025, 8, 22, 23, 38, 23, tzinfo=timezone.utc)
        )
        self.assertEqual(
            alert.updated_at, datetime(2025, 8, 25, 16, 3, 10, tzinfo=timezone.utc)
        )
        self.assertEqual(
            alert.url,
            "https://api.github.com/repos/matt-davis27/PyGithub/code-scanning/alerts/1",
        )
        self.assertEqual(
            alert.html_url,
            "https://github.com/matt-davis27/PyGithub/security/code-scanning/1",
        )
        self.assertEqual(alert.state, "fixed")
        self.assertEqual(
            alert.fixed_at, datetime(2025, 8, 25, 16, 3, 9, tzinfo=timezone.utc)
        )
        ...
        self.assertEqual(
            alert.rule.description, "Workflow does not contain permissions"
        )
        ...
        self.assertEqual(
            alert.most_recent_instance.environment,
            '{"build-mode":"none","language":"actions"}',
        )
        ...
        self.assertEqual(
            ...
            "908396804d41cdb1d0c0538b97f25a81383ee61b",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            alert.most_recent_instance.location.path, ".github/workflows/lint.yml"
        )
        ...
        self.assertEqual(
            alert.instances_url,
            "https://api.github.com/repos/matt-davis27/PyGithub/code-scanning/alerts/1/instances",
        )
    ...
    def testMultipleAlerts(self):
        ...
        self.assertEqual(
            len(alert_list), 14
        )  # Update this when more alerts are added to the PyGithub repo
        ...
        self.assertEqual(
            ...
            datetime(2025, 8, 22, 23, 38, 23, tzinfo=timezone.utc),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            test_alert.fixed_at, datetime(2025, 8, 25, 16, 3, 9, tzinfo=timezone.utc)
        )
        ...
        self.assertEqual(
            test_alert.rule.description, "Workflow does not contain permissions"
        )
        ...
        self.assertEqual(
            test_alert.rule.full_description,
            "Workflows should contain explicit permissions to restrict the scope of the default GITHUB_TOKEN.",
        )
        ...
        self.assertEqual(
            test_alert.most_recent_instance.environment,
            '{"build-mode":"none","language":"actions"}',
        )
        ...
        self.assertEqual(
            test_alert.most_recent_instance.location.path, ".github/workflows/lint.yml"
        )
    ...
    def testRepr(self):
        ...
        self.assertEqual(
            repr(alert),
            'CodeScanAlert(number=1, id="actions/missing-workflow-permissions")',
        )
